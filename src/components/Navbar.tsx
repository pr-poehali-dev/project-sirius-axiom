    ...
    <>
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-semibold text-lg">ЭБУ Маркет</span>
          </div>
        </a>
        ...
        <div className="absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-white/70 transition duration-200 hover:text-white md:flex md:space-x-2">
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#catalog">
            <span className="relative z-20">Каталог</span>
          </a>
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#brands">
            <span className="relative z-20">Бренды</span>
          </a>
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#warranty">
            <span className="relative z-20">Гарантия</span>
          </a>
      ...
      >
        <a className="flex items-center justify-center gap-2" href="/">
          ...
          <span className="text-white font-semibold">ЭБУ Маркет</span>
        </a>
